...
builder.Services.AddSession(options =>
{
    ...
    options.IdleTimeout = TimeSpan.FromSeconds(1000); // Tiempo de inactividad antes de que la sesi�n expire
    options.Cookie.HttpOnly = true; // Asegura que solo se pueda acceder a la cookie desde el servidor
    options.Cookie.IsEssential = true; // Asegura que la cookie est� disponible para el cumplimiento de GDPR
});
